...
k apply -f elasticsearch-eck.yml
k apply -f kibana-eck.yml
sleep 10
elasticpassword=$(kubectl get secret quickstart-es-elastic-user -o=jsonpath='{.data.elastic}' | base64 --decode; echo)
